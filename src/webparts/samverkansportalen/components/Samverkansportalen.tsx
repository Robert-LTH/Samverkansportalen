...
export default class Samverkansportalen extends React.Component<ISamverkansportalenProps> {
  public render(): React.ReactElement<ISamverkansportalenProps> {
    ...
    return (
      <section className={`${styles.samverkansportalen} ${hasTeamsContext ? styles.teams : ''}`}>
